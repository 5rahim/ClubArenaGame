...
export class Model {
    ...
    public all(): Promise<object> {
        ...
        return new Promise((resolve, reject) => {
            ...
            DB.connection.query('SELECT * FROM '+ this.table +'', (err, rows) => {
    ...
    public updateBy(by: string, byValue: string | number | boolean, key: string, value: any) {

        DB.connection.query('UPDATE '+ this.table +' SET '+ key +' = ? WHERE '+ by +' = ?', [value,byValue], (err, rows) => {
